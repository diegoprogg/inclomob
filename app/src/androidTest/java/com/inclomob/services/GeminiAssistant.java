...
public class GeminiAssistant {
    private static final String API_KEY = "SUA_CHAVE_AQUI"; // Use process.env.GEMINI_API_KEY
    private static final String MODEL_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=" + API_KEY;
